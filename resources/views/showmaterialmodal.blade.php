                ...
                <div class="max-w-xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="md:flex">
                        ...
                        <div class="p-8">
                            ...
                            <a href="#">
                                <h2 class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Price: $12 per meter</h2>
                            </a>
                            <p class="mt-2 text-gray-500">Price: $1000</p>
                            <p class="mt-2 text-gray-500">Supplier: DEF Corporation</p>
                            <div class="mt-4">
